...
@Table
@Entity
public class PracownikHibernate {
    ...
    @Id
    @Column(name = "ID_PRACOWNIKHibernate")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    Integer ID;


    public PracownikHibernate() {
    }

    public PracownikHibernate(String wlasnosc1, String wlasnosc2, Integer wlasnosc3, Integer cena, Integer ID) {
